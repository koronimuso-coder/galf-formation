    ...
    <section className="py-24 border-t border-white/5 relative overflow-hidden bg-zinc-950/20">
      ...
      <div className="container-galf relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          {/* Left Selection */}
          <div className="stitch-card p-6 md:p-8 rounded-3xl border border-white/5 relative overflow-hidden stitch-hud-corner">
            ...
            <div className="space-y-4">
              <div className="flex flex-col gap-1.5 font-sans">
                ...
                <select
                  ...
                  className="w-full bg-zinc-900/80 border border-white/5 rounded-xl p-3 text-white text-xs outline-none focus:border-galf-yellow/50"
              ...
              {/* Compare Data Card */}
              <div className="bg-black/40 rounded-2xl p-6 space-y-4 text-xs font-sans text-white/80">
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-zinc-500 font-semibold">Tarif public</span>
                ...
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-zinc-500 font-semibold">Durée formation</span>
                  <span className="font-bold text-white">{d1.duration}</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-zinc-500 font-semibold">Volume pratique</span>
                  <span className="font-bold text-emerald-400">{d1.practice} de pratique terrain</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-zinc-500 font-semibold">Public ciblé</span>
                  <span className="font-bold text-white">{d1.level}</span>
                </div>
                <div className="flex justify-between items-start border-b border-white/5 pb-2 gap-4">
                  <span className="text-zinc-500 font-semibold">Salaire visé</span>
                  <span className="font-bold text-galf-yellow text-right">{d1.salary} / mois</span>
                </div>
                <div className="flex flex-col gap-1">
                  <span className="text-zinc-500 font-semibold">Métiers visés</span>
                  <span className="font-bold text-white text-[11px] leading-tight">{d1.jobs}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="stitch-card p-6 md:p-8 rounded-3xl border border-white/5 relative overflow-hidden stitch-hud-corner">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-black/40 rounded-2xl p-6 space-y-4 text-xs font-sans text-white/80">
                ...
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-zinc-500 font-semibold">Durée formation</span>
                  <span className="font-bold text-white">{d2.duration}</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-zinc-500 font-semibold">Volume pratique</span>
                  <span className="font-bold text-emerald-400">{d2.practice} de pratique terrain</span>
                </div>
                <div className="flex justify-between items-center border-b border-white/5 pb-2">
                  <span className="text-zinc-500 font-semibold">Public ciblé</span>
                  <span className="font-bold text-white">{d2.level}</span>
                </div>
                <div className="flex justify-between items-start border-b border-white/5 pb-2 gap-4">
                  <span className="text-zinc-500 font-semibold">Salaire visé</span>
                ...
                <div className="flex flex-col gap-1">
                  <span className="text-zinc-500 font-semibold">Métiers visés</span>
                  <span className="font-bold text-white text-[11px] leading-tight">{d2.jobs}</span>
                </div>
              </div>
            </div>
          </div>
