  ...
  return (
    <section className="py-24 border-t border-white/5 relative overflow-hidden bg-zinc-950/40">
      ...
      <div className="container-galf max-w-4xl relative z-10">
        <div className="stitch-card p-8 md:p-12 rounded-[2.5rem] border border-white/5 relative overflow-hidden flex flex-col md:flex-row items-center gap-12 stitch-hud-corner shadow-2xl">
          ...
          <div className="w-full md:w-[400px] bg-black/60 border border-white/5 rounded-3xl p-6 relative overflow-hidden stitch-hud-corner">
            {success ? (
              <div className="text-center py-8 space-y-4 animate-fadeIn">
                ...
                <h4 className="text-sm font-black text-white uppercase tracking-wide">Lien Prêt !</h4>
                ...
                <button 
                  ...
                  className="text-[10px] font-bold text-zinc-500 hover:text-white transition-colors uppercase tracking-widest block mx-auto pt-2"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs font-sans">
                <div className="space-y-1">
                  <label className="text-[9px] font-mono text-zinc-500 uppercase tracking-widest block">Nom &amp; Prénom</label>
                  <input
                    type="text"
                    required
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="space-y-1">
                    <label className="text-[9px] font-mono text-zinc-500 uppercase tracking-widest block">E-mail</label>
                    <input
                      type="email"
                      required
                ...
                <div className="space-y-1">
                  <label className="text-[9px] font-mono text-zinc-500 uppercase tracking-widest block">Formation ciblée</label>
                  <select
