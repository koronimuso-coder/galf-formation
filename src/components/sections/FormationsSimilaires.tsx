...
export function FormationsSimilaires({ currentSlug = '' }: { currentSlug?: string }) {
  ...
  return (
    <section className="py-16 border-t border-white/5 bg-zinc-950/20">
      <div className="container-galf">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {related.map((f, idx) => {
            ...
            return (
              <FadeIn key={f.slug} delay={idx * 0.1} className="stitch-card rounded-2xl border border-white/5 overflow-hidden flex flex-col justify-between h-full hover:-translate-y-1 transition-all duration-300 relative group">
                ...
                <div>
                  ...
                  <div className="p-5 space-y-3 font-sans">
                    <h4 className="font-black text-sm uppercase tracking-wide text-white leading-tight block group-hover:text-galf-yellow transition-colors">
                      {f.name}
                    </h4>
                    <p className="text-[11px] text-zinc-400 leading-normal line-clamp-2">
                      {f.shortDesc}
                    </p>
                    <div className="flex gap-4 text-[10px] font-mono text-zinc-500 uppercase tracking-widest pt-2">
                ...
                <div className="p-5 pt-0 flex items-center justify-between border-t border-white/5 mt-4">
                  ...
                  <Link 
                    ...
                    className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-wider text-white hover:text-galf-yellow transition-colors"
                  >
